...
p_arab_dp2_diffid_venn <- upset(fromList(arab_dp2_rdiff_pairs), 
      ...
      sets.bar.color = cbPalette[1], text.scale = c(3, 3, 3, 3, 3, 3))
p_arab_dp2_diffid_venn
...
p_rice_dp2_diffid_venn <- upset(fromList(rice_dp2_rdiff_pairs), 
      ...
      sets.bar.color = cbPalette[2], text.scale = c(3, 2, 3, 1.5, 3, 2))
p_rice_dp2_diffid_venn

# rice 1-1
rice2_dp2_rdiff_pairs <- list(C=rice2_dp2_diffid_C, 
                             CG=rice2_dp2_diffid_CG, 
...
rice_dp2_diffC_rep12_venn_list <- list(rep1=rice_dp2_diffid_C, 
                                         rep2=rice2_dp2_diffid_C)
...
# print(n.elements)
rice_dp2_diffC_rep12_venn <- euler(rice_dp2_diffC_rep12_n.elements, shape = "ellipse")
vennpalette <- c("#fdcc8a", "#d7301f")
p_rice_dp2_diffC_rep12_venn <- plot(rice_dp2_diffC_rep12_venn,
                 quantities = list(fontsize=28, fontfamily="serif",
                                   labels=unname(rice_dp2_diffC_rep12_n.elements)),
                 fills = list(fill=vennpalette, alpha=0.7),
                 edges =TRUE,
                 labels = list(font=2, fontsize=28, fontfamily="serif"), 
...
p_arab_diffid_C_bsvdp2_venn <- plot(arab_diffid_C_bsvdp2_venn,
                                     quantities = list(fontsize=28, fontfamily="serif",
                                                       labels=unname(arab_diffid_C_bsvdp2)),
...
p_arab_diffid_CG_bsvdp2_venn <- plot(arab_diffid_CG_bsvdp2_venn,
                                    quantities = list(fontsize=28, fontfamily="serif",
                                                      labels=unname(arab_diffid_CG_bsvdp2)),
                                    fills = list(fill=palette_bsdp2, alpha=0.7),
                                    edges =TRUE,
                                    labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                    main = list(label="CG", 
...
p_arab_diffid_CHG_bsvdp2_venn <- plot(arab_diffid_CHG_bsvdp2_venn,
                                     quantities = list(fontsize=28, fontfamily="serif",
                                                       labels=unname(arab_diffid_CHG_bsvdp2)),
                                     fills = list(fill=palette_bsdp2, alpha=0.7),
                                     edges =TRUE,
                                     labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                     main = list(label="CHG", 
...
p_arab_diffid_CHH_bsvdp2_venn <- plot(arab_diffid_CHH_bsvdp2_venn,
                                      quantities = list(fontsize=28, fontfamily="serif",
                                                        labels=unname(arab_diffid_CHH_bsvdp2)),
                                      fills = list(fill=palette_bsdp2, alpha=0.7),
                                      edges =TRUE,
                                      labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                      main = list(label="CHH", 
...
p_rice_diffid_C_bsvdp2_venn <- plot(rice_diffid_C_bsvdp2_venn,
                                    quantities = list(fontsize=28, fontfamily="serif",
                                                      labels=unname(rice_diffid_C_bsvdp2)),
                                    fills = list(fill=palette_bsdp2, alpha=0.7),
                                    edges =TRUE,
                                    labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                    main = list(label="C", 
...
p_rice_diffid_CG_bsvdp2_venn <- plot(rice_diffid_CG_bsvdp2_venn,
                                    quantities = list(fontsize=28, fontfamily="serif",
                                                      labels=unname(rice_diffid_CG_bsvdp2)),
                                    fills = list(fill=palette_bsdp2, alpha=0.7),
                                    edges =TRUE,
                                    labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                    main = list(label="CG", 
...
p_rice_diffid_CHG_bsvdp2_venn <- plot(rice_diffid_CHG_bsvdp2_venn,
                                     quantities = list(fontsize=28, fontfamily="serif",
                                                       labels=unname(rice_diffid_CHG_bsvdp2)),
                                     fills = list(fill=palette_bsdp2, alpha=0.7),
                                     edges =TRUE,
                                     labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                     main = list(label="CHG", 
...
p_rice_diffid_CHH_bsvdp2_venn <- plot(rice_diffid_CHH_bsvdp2_venn,
                                      quantities = list(fontsize=28, fontfamily="serif",
                                                        labels=unname(rice_diffid_CHH_bsvdp2)),
                                      fills = list(fill=palette_bsdp2, alpha=0.7),
                                      edges =TRUE,
                                      labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                      main = list(label="CHH", 
...
p_rice2_diffid_C_bsvdp2_venn <- plot(rice2_diffid_C_bsvdp2_venn,
                                    quantities = list(fontsize=28, fontfamily="serif",
                                                      labels=unname(rice2_diffid_C_bsvdp2)),
                                    fills = list(fill=palette_bsdp2, alpha=0.7),
                                    edges =TRUE,
                                    labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                    main = list(label="C", 
...
p_rice2_diffid_CG_bsvdp2_venn <- plot(rice2_diffid_CG_bsvdp2_venn,
                                     quantities = list(fontsize=28, fontfamily="serif",
                                                       labels=unname(rice2_diffid_CG_bsvdp2)),
                                     fills = list(fill=palette_bsdp2, alpha=0.7),
                                     edges =TRUE,
                                     labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                     main = list(label="CG", 
...
p_rice2_diffid_CHG_bsvdp2_venn <- plot(rice2_diffid_CHG_bsvdp2_venn,
                                      quantities = list(fontsize=28, fontfamily="serif",
                                                        labels=unname(rice2_diffid_CHG_bsvdp2)),
                                      fills = list(fill=palette_bsdp2, alpha=0.7),
                                      edges =TRUE,
                                      labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                      main = list(label="CHG", 
...
p_rice2_diffid_CHH_bsvdp2_venn <- plot(rice2_diffid_CHH_bsvdp2_venn,
                                      quantities = list(fontsize=28, fontfamily="serif",
                                                        labels=unname(rice2_diffid_CHH_bsvdp2)),
                                      fills = list(fill=palette_bsdp2, alpha=0.7),
                                      edges =TRUE,
                                      labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                      main = list(label="CHH", 
...
make_two_sets_venn_data <- function(rep1set, rep2set){
  venn_list <- list(rep1=rep1set, rep2=rep2set)
  # plot venn with euler =================
  venn_combs <-
    unlist(lapply(1:length(venn_list),
                  function(j) combn(names(venn_list), j, simplify = FALSE)),
...
p_rice_diffid_CG_bsvdp2_venn <- plot(rice_diffid_CG_bsvdp2_venn,
                                    quantities = list(fontsize=28, fontfamily="serif",
                                                      labels=unname(rice_dp2_diffCG_rep12)),
                                    fills = list(fill=vennpalette, alpha=0.7),
                                    edges =TRUE,
                                    labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                    main = list(label="CG", 
...
p_rice_diffid_CHG_bsvdp2_venn <- plot(rice_diffid_CHG_bsvdp2_venn,
                                     quantities = list(fontsize=28, fontfamily="serif",
                                                       labels=unname(rice_dp2_diffCHG_rep12)),
                                     fills = list(fill=vennpalette, alpha=0.7),
                                     edges =TRUE,
                                     labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                     main = list(label="CHG", 
...
p_rice_diffid_CHH_bsvdp2_venn <- plot(rice_diffid_CHH_bsvdp2_venn,
                                      quantities = list(fontsize=28, fontfamily="serif",
                                                        labels=unname(rice_dp2_diffCHH_rep12)),
                                      fills = list(fill=vennpalette, alpha=0.7),
                                      edges =TRUE,
                                      labels = list(font=2, fontsize=28, fontfamily="serif"), 
                                      main = list(label="CHH", 
