...
pa <- ggplot(data=s1a, aes(x=motif, y=methylevel, fill=replicate)) +
  ...
  theme(legend.position = "bottom", 
        ...
        plot.title = element_text(size=18, hjust = -0.13, vjust=-0.13, face = "bold"),  # 20
...
pb <- ggplot(data=s1b, aes(x=ranges, y=ratio, fill=replicate)) +
  geom_bar(stat="identity", position=position_dodge(), colour="black") + 
  annotate("text",x="0.4-0.5",y=35,hjust=0,vjust=0,label="CpG", size=6, family="Arial") + # 6
  theme_bw() + 
  theme(legend.position = "bottom", 
        legend.title = element_blank(),
...
pc <- ggplot(data=s1c, aes(x=ranges, y=ratio, fill=replicate)) +
  geom_bar(stat="identity", position=position_dodge(), colour="black") + 
  annotate("text",x="0.4-0.5",y=42,hjust=0,vjust=0,label="CHG", size=6, family="Arial") +
  theme_bw() + 
  theme(legend.position = "bottom", 
        legend.title = element_blank(),
        legend.key.size = unit(0.35, "cm"), 
