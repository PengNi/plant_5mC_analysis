...
p_a <- ggplot(data = df.cot_arab, aes(y=Pearson_Correlation, x=motif, fill = method, 
  ...
  geom_text(size=2.5, position=position_dodge(width=0.9),
...
ppi= 300
png("tools_to_cmp/eval.tools_cmp.10x.arab_rep123.rice_2-1_rep2-1.bnigra.raw.png", 
    width = 18, 
...
svg("tools_to_cmp/eval.tools_cmp.10x.arab_rep123.rice_2-1_rep2-1.bnigra.raw.svg", 
    width = 18/2.54, 
    height = 9/2.54)
grid.arrange(arrangeGrob(p_a + theme(legend.position = "none"), 
                         grid.rect(gp=gpar(col="white")),
