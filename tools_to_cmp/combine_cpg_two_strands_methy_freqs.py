...
def add_crmet_and_pqvalue(mposinfo, conversion_rate=0.9966):
...
def main():
    ...
    parser.add_argument('-t', "--rtype", help="bs or deepsignal, or bedmethyl",
                        type=str, default='bs')
    ...
    if rtype == 'bs':
        ...
        mposinfo = add_crmet_and_pqvalue(mposinfo, conversion_rate)
